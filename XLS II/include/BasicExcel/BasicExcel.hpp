...
public: // Worksheet functions.
	...
	bool GetSheetName(int sheetIndex, std::string* name);		///< Get the worksheet name at the given index. Index starts from 0. Returns false if name is in Unicode format.
	bool GetSheetName(int sheetIndex, std::wstring* name);	///< Get the worksheet name at the given index. Index starts from 0. Returns false if name is in Ansi format.
